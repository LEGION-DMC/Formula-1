const startingGridData = [ 
    { position: 1, driverId: 'russell', team: '' },
    { position: 2, driverId: 'leclerc', team: '' },
    { position: 3, driverId: 'piastri', team: '' },
    { position: 4, driverId: 'hadjar', team: '' },
    { position: 5, driverId: 'norris', team: '' },
    { position: 6, driverId: 'hamilton', team: '' },
    { position: 7, driverId: 'gasly', team: '' },
    { position: 8, driverId: 'verstappen', team: '' },
    { position: 9, driverId: 'colapinto', team: '' },
    { position: 10, driverId: 'bearman', team: '' },
	
    { position: 11, driverId: 'lawson', team: '' },
    { position: 12, driverId: 'albon', team: '' },
    { position: 13, driverId: 'ocon', team: '' },
    { position: 14, driverId: 'sainz', team: '' },
    { position: 15, driverId: 'lindblad', team: '' },
    ...
    { position: 21, driverId: 'alonso', pitLane: false, team: '' },
