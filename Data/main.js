const startingGridData = [ 
    { position: 1, driverId: 'norris', team: '' },
    { position: 2, driverId: 'antonelli', team: '' },
    { position: 3, driverId: 'verstappen', team: '' },
    { position: 4, driverId: 'hamilton', team: '' },
    { position: 5, driverId: 'leclerc', team: '' },
    { position: 6, driverId: 'russell', team: '' },
    { position: 7, driverId: 'piastri', team: '' },
    { position: 8, driverId: 'lawson', team: '' },
    { position: 9, driverId: 'colapinto', team: '' },
    { position: 10, driverId: 'lindblad', team: '' },
    { position: 11, driverId: 'hulkenberg', team: '' },
    { position: 12, driverId: 'bortoleto', team: '' },
    { position: 13, driverId: 'ocon', team: '' },
    { position: 14, driverId: 'gasly', team: '' },
    { position: 15, driverId: 'tsunoda', team: 'Racing Bulls' },
    { position: 16, driverId: 'albon', team: '' },
    { position: 17, driverId: 'alonso', team: '' },
    { position: 18, driverId: 'perez', team: '' },
    { position: 19, driverId: 'bottas', team: '' },
    { position: 20, driverId: 'sainz', team: '' },
