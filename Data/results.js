...
const standingsData = {
    drivers: [
        { position: 1, name: "Оскар Пиастри", team: "McLaren", points: 266, sprintPoints: 21, driverId: "piastri", flag: "au.svg", teamId: "McLaren", state: "Австралия"},
        { position: 2, name: "Ландо Норрис", team: "McLaren", points: 250, sprintPoints: 15, driverId: "norris", flag: "gb.svg", teamId: "McLaren", state: "Великобритания" },
        { position: 3, name: "Шарль Леклер", team: "Ferrari", points: 139, sprintPoints: 9, driverId: "leclerc", flag: "mc.svg", teamId: "Ferrari", state: "Манако" },
        { position: 4, name: "Льюис Хэмильтон", team: "Ferrari", points: 109, sprintPoints: 14, driverId: "hamilton", flag: "gb.svg", teamId: "Ferrari", state: "Великобритания" },
        { position: 5, name: "Джордж Рассел", team: "Mercedes", points: 157, sprintPoints: 10, driverId: "russell", flag: "gb.svg", teamId: "Mercedes", state: "Великобритания" },
        { position: 6, name: "Кими Антонелли", team: "Mercedes", points: 63, sprintPoints: 4, driverId: "antonelli", flag: "it.svg", teamId: "Mercedes", state: "Италия" },
	{ position: 7, name: "Макс Ферстаппен", team: "Red Bull", points: 185, sprintPoints: 14, driverId: "verstappen", flag: "nl.svg", teamId: "RedBull", state: "Нидерланды" },
        { position: 8, name: "Юки Цунода", team: "Red Bull", points: 10, sprintPoints: 6, driverId: "tsunoda", flag: "jp.svg", teamId: "RedBull", state: "Япония" },
	{ position: 9, name: "Карлос Сайнс", team: "Williams", points: 16, sprintPoints: 3, driverId: "sainz", flag: "es.svg", teamId: "Williams", state: "Испания" },
        { position: 10, name: "Александр Албон", team: "Williams", points: 54, sprintPoints: 0, driverId: "albon", flag: "th.svg", teamId: "Williams", state: "Тайвань" },
        { position: 11, name: "Нико Хюлькенберг", team: "Sauber", points: 37, sprintPoints: 0, driverId: "hulkenberg", flag: "de.svg", teamId: "Sauber", state: "Германия" },
        { position: 12, name: "Габриэл Бортолето", team: "Sauber", points: 6, sprintPoints: 0, driverId: "bortoleto", flag: "br.svg", teamId: "Sauber", state: "Бразилия" },
        { position: 13, name: "Лиам Лоусон", team: "Racing Bulls", points: 16, sprintPoints: 0, driverId: "lawson", flag: "nz.svg", teamId: "RacingBulls", state: "Новая Зеландия" },
        { position: 14, name: "Исаак Хаджар", team: "Racing Bulls", points: 22, sprintPoints: 0, driverId: "hadjar", flag: "fr.svg", teamId: "RacingBulls", state: "Франция" },
        { position: 15, name: "Лэнс Стролл", team: "Aston Martin", points: 20, sprintPoints: 0, driverId: "stroll", flag: "ca.svg", teamId: "AstonMartin", state: "Канада" },
        { position: 16, name: "Фернандо Алонсо", team: "Aston Martin", points: 16, sprintPoints: 0, driverId: "alonso", flag: "es.svg", teamId: "AstonMartin", state: "Испания" },
        { position: 17, name: "Эстебан Окон", team: "Haas", points: 27, sprintPoints: 0, driverId: "ocon", flag: "fr.svg", teamId: "Haas", state: "Франция" },
        { position: 18, name: "Оливер Берман", team: "Haas", points: 8, sprintPoints: 2, driverId: "bearman", flag: "gb.svg", teamId: "Haas", state: "Великобритания" },
        { position: 19, name: "Пьер Гасли", team: "Alpine", points: 20, sprintPoints: 1, driverId: "gasly", flag: "fr.svg", teamId: "Alpine", state: "Франция" },
        { position: 20, name: "Франко Колапинто", team: "Alpine", points: 0, sprintPoints: 0, driverId: "colapinto", flag: "ar.svg", teamId: "Alpine", state: "Аргентина" },
    ],
